...
public class ShakeActivity extends AppCompatActivity implements SensorEventListener {
    ...
    //Creates an optionsmenu which can be opened
    @Override
    ...
    //Switches between optionmenu items and starts new activity if clicked
    @Override
    ...
    //Delays displaying answer 2 seconds after shaking
    @Override
    ...
    //Removes event listener from sensorManager
    @Override
    ...
    //If shake was strong enough, answer will be displayed
    @Override
    ...
    //Checks if shake was hard enough
    ...
    //Displays answer with animation
    ...
    //Gets random answer from Strings.xml
    private String getAnswer(){
        int randomInt = RANDOM.nextInt(answers.size());
        return answers.get(randomInt);
    }

    //Loads all answers from Strings.xml and puts them into array list
